from Classes.support import *
from Classes.tiles import Tile, StaticTile, Crate,Coin, Palm
from Classes.settings import tile_size, screen_height, screen_width
from Classes.player import Player
from Classes.enemy import Enemy
from Classes.decoration import Sky,Water,Clouds
from Classes.particles import ParticleEffect
...
class Level:
    ...
    def player_setup(self,layout):
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == '1':
                    hat_surface = pygame.image.load('graphicss/character/hat.png').convert_alpha()
    ...
    def run(self):
        ...
        self.constraint_sprites.update(self.world_shift) # we use this blocks to change direction
